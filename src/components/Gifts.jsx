...
function Gifts({ bankAccount = null, bankName = null, accountHolder = null, cbu = null, alias = null }) {
  return (
    <section className="gifts">
      <div className="container">
        <div className="gifts-content">
          ...
          <p className="gifts-subtitle">Tu presencia es el mejor regalo, pero si querés hacernos un obsequio, podés hacer una transferencia</p>
